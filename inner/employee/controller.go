...
type Svc interface {
	...
	Add(ctx context.Context, req CreateRequest) error
	Save(ctx context.Context, req CreateRequest) (int64, error)
	FindAll(ctx context.Context) ([]Response, error)
	FindByIds(ctx context.Context, ids []int64) ([]Response, error)
	DeleteById(ctx context.Context, id int64) error
	DeleteByIds(ctx context.Context, ids []int64) error
	SaveWithTransaction(ctx context.Context, e CreateRequest) (int64, error)
	GetEmployeesPage(ctx context.Context, req PageRequest) (PageResponse, error)
}
...
func (c *Controller) CreateEmployee(ctx *fiber.Ctx) error {
	...
	var newEmployeeId, err = c.employeeService.SaveWithTransaction(ctx.Context(), request)
	if err != nil {
		switch {
...
func (c *Controller) AddEmployee(ctx *fiber.Ctx) error {
	...
	if err := ctx.BodyParser(&req); err != nil {
		c.logger.ErrorCtx(ctx.Context(), "Add employee", zap.Error(err))
		return common.ErrResponse(ctx, fiber.StatusBadRequest, err.Error())
	}
	c.logger.DebugCtx(ctx.Context(), "Add employee: received request", zap.Any("request", req))
	if err := c.employeeService.Add(ctx.Context(), req); err != nil {
		switch {
		case errors.As(err, &common.RequestValidationError{}) || errors.As(err, &common.AlreadyExistsError{}):
			c.logger.ErrorCtx(ctx.Context(), "Add employee", zap.Error(err))
			return common.ErrResponse(ctx, fiber.StatusBadRequest, err.Error())
...
func (c *Controller) SaveEmployee(ctx *fiber.Ctx) error {
	var req CreateRequest
	if err := ctx.BodyParser(&req); err != nil {
		c.logger.ErrorCtx(ctx.Context(), "Save employee", zap.Error(err))
		return common.ErrResponse(ctx, fiber.StatusBadRequest, err.Error())
	}
	c.logger.DebugCtx(ctx.Context(), "Save employee: received request", zap.Any("request", req))
	id, err := c.employeeService.Save(ctx.Context(), req)
	if err != nil {
		switch {
		case errors.As(err, &common.RequestValidationError{}) || errors.As(err, &common.AlreadyExistsError{}):
			c.logger.ErrorCtx(ctx.Context(), "Save employee", zap.Error(err))
...
func (c *Controller) GetEmployee(ctx *fiber.Ctx) error {
	...
	if err != nil {
		c.logger.ErrorCtx(ctx.Context(), "Get employee", zap.Error(err))
...
func (c *Controller) GetAllEmployees(ctx *fiber.Ctx) error {
	resps, err := c.employeeService.FindAll(ctx.Context())
	if err != nil {
		c.logger.ErrorCtx(ctx.Context(), "Get all employee", zap.Error(err))
		return common.ErrResponse(ctx, fiber.StatusInternalServerError, err.Error())
	}
...
func (c *Controller) GetEmployeesPage(ctx *fiber.Ctx) error {
	...
	c.logger.DebugCtx(ctx.Context(), "GetEmployeesPage ", zap.Any("request", req))
	pageResp, err := c.employeeService.GetEmployeesPage(ctx.Context(), req)
	if err != nil {
...
func (c *Controller) GetEmployeesByIds(ctx *fiber.Ctx) error {
	...
	c.logger.DebugCtx(ctx.Context(), "Get all employee by ids", zap.Int64s("ids", ids))

	resps, err := c.employeeService.FindByIds(ctx.Context(), ids)
	if err != nil {
...
func (c *Controller) DeleteEmployeeById(ctx *fiber.Ctx) error {
	...
	id, err := strconv.ParseInt(idParam, 10, 64)
	c.logger.DebugCtx(ctx.Context(), "Delete employees by id", zap.String("id", idParam))

	if err != nil {
		c.logger.ErrorCtx(ctx.Context(), "Delete employee", zap.Error(err))
		return common.ErrResponse(ctx, fiber.StatusBadRequest, "invalid id")
	}
...
func (c *Controller) DeleteEmployeesByIds(ctx *fiber.Ctx) error {
	...
	c.logger.DebugCtx(ctx.Context(), "Delete employees by ids", zap.Int64s("ids", ids))
	if err := c.employeeService.DeleteByIds(ctx.Context(), ids); err != nil {
		c.logger.ErrorCtx(ctx.Context(), "Delete employee", zap.Error(err))
		return common.ErrResponse(ctx, fiber.StatusInternalServerError, err.Error())
	}
	return common.OkResponse(ctx, fiber.Map{"message": "deleted"})
